...
HD_PWD='C:/Xilinx/Projects/rover_firmware/urc_rover/urc_rover.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log urcRover.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source urcRover.tcl -notrace
